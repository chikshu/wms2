...
if(isset($_POST['invoice_name'])){
	...
	$ordId = $_POST['invoice_name'];
	}
?>
<script>
var page="invoice-view";
...
.overlay_div textarea {
  ...
  <h2 class="heading" class="h1"> Invoice View</h2>  
  ...
  <div id="invoice_form"  style="display:none;" >
	  <form method="post" action="<?php echo get_site_url(); ?>/over-the-counter-invoice/" id="invoice_form_id"> 
